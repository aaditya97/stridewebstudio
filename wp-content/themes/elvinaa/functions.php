...
function elvinaa_scripts() {
	...
	wp_enqueue_style( 'elvinaa-responsive', get_template_directory_uri() . '/css/elvinaa-style-responsive.css', array(), '1.0.3');	   
	...
	wp_enqueue_script( 'elvinaa-script', get_template_directory_uri() . '/js/elvinaa-main.js', array('jquery'), '1.0.3', true );		
